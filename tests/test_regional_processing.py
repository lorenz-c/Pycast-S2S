...
from src.helper_modules import decode_processing_years
from src.helper_modules import decode_processing_months

@pytest.mark.parametrize("year_string, decoded_years", [
                         ('2000', [2000]),
...
@pytest.mark.parametrize("month_string, decoded_months", [
                         ('01', [1]),
                         ('2,0,6', range(2, 7)),
                         ('01,10', [1, 10]),
                         ('4,6,7', [4,6,7])])
